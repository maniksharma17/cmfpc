...
const MUSIC_VIDEOS = [
  ...
  "https://pub-01b195b4f45d4731908d3e577c63b40e.r2.dev/cinemalt-content/music-videos/The%20Center%20Piece_2.mp4",
  "https://pub-01b195b4f45d4731908d3e577c63b40e.r2.dev/cinemalt-content/music-videos/The%20Center%20Piece_3.mp4",
];
    ...
    <main className="bg-stone-800 text-stone-100 w-full min-h-screen">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-start justify-center lg:px-24 px-6">
        ...
        >
          ...
          cinematic stories that amplify the emotion of every beat, helping
          artists connect deeply with their audience.{" "}
        </motion.p>
