...
function VideoTile({ src, index }: { src: string; index: number }) {
  ...
  return (
    ...
    >
      <div className="group relative w-full overflow-hidden bg-black" onClick={togglePlay}>
        <video
          ref={videoRef}
  ...
  return (
    <main className="bg-stone-800 text-stone-100 w-full min-h-screen">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-start justify-center lg:px-24 px-6">
        ...
        >
          Our brand films go beyond storytelling — they craft immersive visual journeys that connect audiences to the soul of a brand. From concept to screen, each film is designed to inspire, engage, and leave a lasting impression.
        </motion.p>
